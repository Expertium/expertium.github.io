...
4. By 2029, no algorithm in our benchmark will have achieved an (weighted by reviews) AUC score higher than 0.83, unless the dataset used in the benchmark changes.
