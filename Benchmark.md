...
So what this really means is not "in 18% of cases, default parameters fit the data better", but "in 18% of cases, FSRS fails to generalize sufficiently well and doesn't perform well on new, unseen data". This is more likely to happen if the amount of data (reviews) is low, and less likely to happen for old, large collections.
