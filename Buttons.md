...
3) average_t(Again) > average_t(Hard) > average_t(Good) > average_t(Easy) is true only for 40% of users. It could be due to noise, it could be that some people really do take longer to answer Hard than Again (about 21%).
